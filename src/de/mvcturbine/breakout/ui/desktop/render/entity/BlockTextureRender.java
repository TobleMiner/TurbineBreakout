...
public class BlockTextureRender extends EntityTextureRender
{
	...
	protected void initCache() throws IOException
	{
		this.cache.loadImageFromResource(
				"/de/mvcturbine/breakout/resources/graphics/textures/blockYellow.png",
				1);
		this.cache.loadImageFromResource(
				"/de/mvcturbine/breakout/resources/graphics/textures/blockGreen.png",
				2);
		this.cache.loadImageFromResource(
				"/de/mvcturbine/breakout/resources/graphics/textures/blockRed.png",
				3);
		this.cache.loadImageFromResource(
				"/de/mvcturbine/breakout/resources/graphics/textures/blockBlue.png",
				4);
	}
}
